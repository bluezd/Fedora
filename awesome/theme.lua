...
-- theme.wallpaper_cmd = { "awsetbg /home/zhudong/.config/awesome/icons/background.jpg" }
theme.wallpaper_cmd = { "awsetbg /home/zhudong/.config/awesome/icons/0300_wallpaper.jpg" }
